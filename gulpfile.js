...
function watchFiles() {
    ...
    watch([paths.baseSrcAssets + "scss/**/*.scss", paths.configTailwind, "!" + paths.baseSrcAssets + "scss/icons.scss", "!" + paths.baseSrcAssets + "scss/icons/*.scss"], series(style));
}

// Producaton Tasks
exports.default = series(
    vendor,
    parallel(javascript, style, icons),
    parallel(watchFiles)
);
